...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('barang', BarangController::class)->except('create', 'show', 'edit', 'destroy');
    Route::resource('pembeli', PembeliController::class)->except('create', 'show', 'edit', 'destroy');
