	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Tambah Premission</h5>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="mb-3">
								...
								<select name="role" id="role" value="{{ old('role') }}" class="form-control @error('role') is-invalid @enderror" name="role" id="role">
									<option value="ADMIN">Admin</option>
									<option value="STAFF">Staf</option>
								</select>
								{{-- <input type="email" class="form-control @error('role') is-invalid @enderror" name="role" id="role"
